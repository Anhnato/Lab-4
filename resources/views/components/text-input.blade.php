<div class="flex flex-col w-full">
    ...
    'class' =>
        ...
        placeholder="{{ $placeholder ?? '' }}" @if (isset($model)) wire:model="{{ $model }}" @endif @if (isset($name))
        name="{{ $name }}" @endif @if (isset($readonly)) readonly="true" @endif @if (isset($value)) value="{{ $value }}"
        @endif />
