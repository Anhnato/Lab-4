<div x-data="{ offcanvas: false }" class="z-50 fixed top-0 left-0 right-0 bottom-0" style="display: none;"
    x-show="offcanvas">
    <div class="h-full" x-on:display-offcanvas.window="offcanvas = true"
